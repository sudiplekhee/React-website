...
<div className="bg-white">
  ...
  <section className="bg-indigo-500 text-white py-12 px-4">
  ...
  <section className="text-center py-12 px-4">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mt-8">
      <div className="p-4 shadow-lg rounded-lg bg--100 hover:bg--200 transition-colors">
  ...
  <section className="bg-indigo-500 text-white text-center py-12 px-4">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8 max-w-5xl mx-auto">
      <div className="p-4 shadow-lg rounded-lg bg-indigo-600 hover:bg-indigo-500 transition-colors">
  ...
  <footer className="bg-indigo-500 text-white text-center py-8">
    <p>© Copyright [Sudip chaudhary]] . All rights reserved. Made By Binary Boats⛵</p>
  </footer>
</div>
